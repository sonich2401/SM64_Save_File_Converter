...
string replace(string src, string filter, string replacement){
    ...
    string ret = malloc(AMOUNT_PASTED_REPLACEMENT + AMOUNT_SAVED_SRC + 1 ); //Give us a string that can hold the new string
